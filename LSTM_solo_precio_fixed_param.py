...
# Redimensionar para la entrada de la LSTM
...
def create_model(neurons, learning_rate, dense_layers):
    model = Sequential([
        LSTM(celdasR, activation="tanh", return_sequences=False, input_shape=(input_steps, 1)),
    ])
...
# Encontrar la mínima pérdida de validación
