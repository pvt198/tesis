...
# Función para crear el modelo con GRU
def create_model(neurons, learning_rate, dense_layers, recurrent, gru_units):
    model = Sequential([
        GRU(gru_units, activation="tanh", return_sequences=bool(recurrent), input_shape=(input_steps, 1)),
    ])
...
for params in param_combinations:
    neurons, learning_rate, batch_size, epochs, dense_layers, recurrent, gru_units = params
    print(
        ...
        f"recurrent={recurrent}, GRU_units={gru_units}")

    model = create_model(neurons, learning_rate, dense_layers, recurrent, gru_units)
    #Plot el modelo
